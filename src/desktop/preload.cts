...
const kinagentApi = {
  ...
  resolveGroupGamingRoll: (input: unknown) => ipcRenderer.invoke("gaming:resolve-roll", input),
  dismissGroupGamingRoll: (input: unknown) => ipcRenderer.invoke("gaming:dismiss-roll", input),
