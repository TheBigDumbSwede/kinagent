...
export const soundscapePresets: Record<SoundscapePresetId, SoundscapeState> = {
  rainy_room: {
    ...
    transition: "fade",
    layers: [
      { type: "rain", volume: 0.52, density: 0.72, warmth: 0.34, movement: 0.42 },
      { type: "roomTone", volume: 0.38, density: 0.42, warmth: 0.68 },
      { type: "lowDrone", volume: 0.14, pitch: 82, warmth: 0.72, movement: 0.16 }
    ]
  },
  windy_night: {
    enabled: true,
    ...
    transition: "fade",
    layers: [
      { type: "wind", volume: 0.48, density: 0.58, warmth: 0.28, movement: 0.76 },
      { type: "roomTone", volume: 0.35, density: 0.38, warmth: 0.52 },
      { type: "lowDrone", volume: 0.16, pitch: 73, warmth: 0.36, movement: 0.24 }
    ]
  },
  spaceship_idle: {
    enabled: true,
    ...
    transition: "fade",
    layers: [
      { type: "hum", volume: 0.3, pitch: 58, warmth: 0.48, movement: 0.28 },
      { type: "lowDrone", volume: 0.16, pitch: 46, warmth: 0.34, movement: 0.18 },
      { type: "static", volume: 0.12, density: 0.22, warmth: 0.24, movement: 0.18 }
    ]
  },
  eerie_static: {
    enabled: true,
    ...
    transition: "swell",
    layers: [
      { type: "static", volume: 0.24, density: 0.62, warmth: 0.16, movement: 0.36 },
      { type: "lowDrone", volume: 0.18, pitch: 55, warmth: 0.22, movement: 0.22 },
      { type: "tensionPulse", volume: 0.18, pitch: 98, density: 0.42, warmth: 0.22, movement: 0.52 }
    ]
  },
  calm_room: {
    enabled: true,
    ...
    transition: "fade",
    layers: [
      { type: "roomTone", volume: 0.4, density: 0.32, warmth: 0.7 },
      { type: "lowDrone", volume: 0.12, pitch: 74, warmth: 0.76, movement: 0.1 }
    ]
  }
};
